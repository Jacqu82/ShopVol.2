...
<div class="container text-center">
    ...
    $orders = OrderRepository::loadLastUnpaidOrderByUserIdAndOrderId($connection, $user->getId(), $_SESSION['order_id']);
    foreach ($orders as $order) {
        $image = ImageRepository::loadFirstImageByProductId($connection, $order['product_id']);
